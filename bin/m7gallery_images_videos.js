        ...
        for (const file of files) {
            ...
            if (ext === '.jpg' || ext === '.jpeg' || ext === '.png') {
                ...
                if (i === thumbIndex) {
                    ...
                    await (0, sharp_1.default)(outFile)
                ...
                const videoTrackProps = await (0, getVideoProps_1.default)(file);
                ...
                const { videoFile } = await (0, encodeHLSVideo_1.default)(file, gallerySlug, resolutions);
                const thumbPath = path_1.default.join(gallerySlug, parsed.name, 'thumb.jpg');
                await (0, generateVideoThumbnail_1.default)(file, thumbPath);
                data.slides.push({
